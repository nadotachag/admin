...
//      live: 'disabled',
			...
			cniFon: {
                validators: {
                    ...
                    stringLength: {
                        min: 2,
                        max: 18,
                        message: '<font color="red">Le prenom doit comporter plus de 2 caractères et moins de 18 caractères</font>'
                    },
                }
            },
			dateNaissFon: {
                validators: {
                    ...
                    stringLength: {
                        min: 2,
                        max: 24,
                        message: '<font color="red">Le prenom doit comporter plus de 2 caractères et moins de 24 caractères</font>'
                    },
                }
            },
			lieuNaissFon: {
        ...
        onSuccess: function(e, data) {
            ...
            function uploadImage($form){
              ...
              request.open('post', 'handler/add-fonctionnaire.php');
              request.send(formdata);
                request.addEventListener('error', function (xhr) {
                    console.log(xhr);
                });
