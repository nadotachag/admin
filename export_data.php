...
$sql = "SELECT num_volontaire, prenom_par, nom_par, num_contact_tel_par, operateur_par, ville_par, type_client_par, type_acces_par, offre_service_par FROM participation where active_par='1' ORDER BY num_volontaire DESC";  
